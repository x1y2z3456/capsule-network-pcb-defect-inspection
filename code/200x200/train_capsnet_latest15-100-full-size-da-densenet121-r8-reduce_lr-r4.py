...
model_name = 'keras_densenet_capsule_trained_model-r8-r4.h5'
...
# callbacks
log = CSVLogger(DATASET_PATH + 'log-capsnet-latest-15-200-full-size-da-densenet121-r8-r4.csv')
checkpoint = ModelCheckpoint(DATASET_PATH + 'weights-capsnet-latest-15-200-full-size-da-densenet121-r8-r4-{epoch:02d}.h5', monitor='val_accuracy', save_best_only=True, save_weights_only=False, verbose=1)
...
plt.ylabel('True')
plt.savefig('cm_capsnet_latest15-200-full-size-da-densenet121-r8-r4.png')
# plt.show()
end = time.time()
