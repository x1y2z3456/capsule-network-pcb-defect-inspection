...
model_name = 'keras_densenet_capsule_trained_model-r8-r6-no-da.h5'
...
# callbacks
log = CSVLogger(DATASET_PATH + 'log-capsnet-latest-15-200-full-size-no-da-densenet121-r8-r6.csv')
checkpoint = ModelCheckpoint(DATASET_PATH + 'weights-capsnet-latest-15-200-full-size-no-da-densenet121-r8-r6-{epoch:02d}.h5', monitor='val_accuracy', save_best_only=True, save_weights_only=False, verbose=1)
...
plt.ylabel('True')
plt.savefig('cm_capsnet_latest15-200-full-size-no-da-densenet121-r8-r6.png')
# plt.show()
end = time.time()
