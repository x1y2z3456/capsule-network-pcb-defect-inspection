...
plot_fig_with_text('log-capsnet-new.csv', 100)
print('Origin Capsnet 300 epoch')
plot_fig_with_text('log-capsnet-origin-300-2-da-r-size.csv', 300)
print('')
print('DenseNet121 100 epoch')
plot_fig_with_text('log-densenet121-size.csv', 100)
print('ResNet50 100 epoch')
plot_fig_with_text('log-resnet-new.csv', 100)
print('VGG19 100 epoch')
plot_fig_with_text('log-vgg19-size.csv', 100)
