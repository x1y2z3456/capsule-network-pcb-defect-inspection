...
print('New CapsNet')
model.load_weights('weights-capsnet-new-5-164.h5')
...
print('ResNet-50')
model_2 = models.load_model('model-resnet50-size+.h5')
...
# 繪製所有模型的ROC曲線
plt.plot(fpr_0, tpr_0, color='blue', lw=2, label='New CapsNet V1+ (AUC = %0.4f)' % auc_0)
