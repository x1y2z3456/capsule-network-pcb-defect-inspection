...
print('New Capsnet V2 200 epoch')
plot_fig_with_text('log-capsnet-new-7.csv', 200)
print('Origin Capsnet 300 epoch')
plot_fig_with_text('log-capsnet-origin-2-size+-300.csv', 300)
print('')
print('DenseNet121 100 epoch')
plot_fig_with_text('log-densenet121-new-size+.csv', 100)
print('ResNet50 100 epoch')
plot_fig_with_text('log-resnet50-size+.csv', 100)
